...
def make_coadds():
    ...
    if True:
        ...
        basepat = 'unwise2-w%i-lb-%i-%i.fits' #% (band, scalelevel, H)
        #jpegfn = 'wlb.jpg'
...
def make_jpeg(fns, jpegfn, scale_allwise=False):
    ...
    w1,w2 = [fitsio.read(fn) for fn in fns]
...
if __name__ == '__main__':
    ...
    fns = ['unwise2-w1-lb-5-4096.fits',
           'unwise2-w2-lb-5-4096.fits',]
    make_jpeg(fns, 'unwise2-wlbzoom.png')
